...
demo/blocks.jst.js: $(shell find ./blocks -name '*.jst') node_modules
	$(NPM_BIN)/jst --template=underscore --include=blocks/*/*.jst --variable=data --output=demo/tmp.jst.js
...
demo/demo.jst.js: $(shell find ./demo -name '*.jst') demo/blocks.jst.js
	$(NPM_BIN)/jst --template=underscore --include=demo/*.jst --variable=data --output=demo/tmp.jst.js
